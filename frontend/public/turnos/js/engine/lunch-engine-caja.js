/**
 * lunch-engine-caja.js
 * Motor de almuerzos de Caja Centro v6 (solo meses históricos < julio 2026).
 * Firebase no guarda almuerzos — se calculan igual que en cajacentro-v6.web.app.
 *
 * Reglas por grupo:
...
(function () {
  ...
  /** Valores junio 2026 en Caja Centro (distintos al motor WhatsApp julio+). */
  const ALMUERZO_FIJO = {
    jhon_lozano:       '2:00',
    brayan_ramirez:    '12:00',
    brandon:           '1:00',
    jonathan_sanchez:  '1:00',
    jhonny_rodriguez:  '1:00',
    mauricio_bautista: '1:00',
    brayan_yate:       '3:00',
    david_sanchez:     '1:00',
  };

  const { getLunchTrio, getAusenteTrio } = window.ENGINE_RULES_MESSENGERS_CAJA;
  ...
  window.ENGINE_LUNCH_CAJA = ENGINE_LUNCH_CAJA;
