#!/bin/bash
# Script para crear server.ts completo en Cloud Shell

cat > ~/whatsapp-cloud-run/src/server.ts << 'SERVEREOF'
...
echo "✅ Archivo server.ts creado correctamente"
wc -l ~/whatsapp-cloud-run/src/server.ts
